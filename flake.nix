{
    ...
    description = "Create a nested hydra / deino and bind it to a keymap using general / alloy in one go!";
    inputs = rec {
        ...
        epkg-alloy.url = github:syvlorg/alloy;
    ...
    outputs = inputs@{ self, flake-utils, settings, ... }: with builtins; with settings.lib; with flake-utils.lib; settings.mkOutputs {
        ...
        callPackage = { emacs, pname }: emacs.pkgs.trivialBuild rec {
            ...
            propagatedUserEnvPkgs = with emacs.pkgs; flatten [ alloy deino deino.propagatedUserEnvPkgs ];
            meta = {
